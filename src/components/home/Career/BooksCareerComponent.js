        ...
        {[
          ...
          return (
            <a
              ...
              key={index}
            >
              <Tooltip title={"Book name here"} arrow={true}>
                <div className="h-48 border hover:shadow-md flex flex-col  p-1">
                  ...
                  <div className="text-center h-10  text-sm overflow-hidden overflow-ellipsis ">
                    Book Name hello how are
                    youhklfhsklfhskldfjklsjlkfjsdlkjlsldfjldskjf
                  </div>
                </div>
              </Tooltip>
            </a>
...
export default BooksCareerComponent;
